...
var MSelectTagsService = (function () {
    ...
    MSelectTagsService.prototype.getSyncOptions = function (list, keyword, listBy) {
        return rxjs_Observable.Observable.of(list.filter(function (item) {
...
MSelectTagsComponent.propDecorators = {
    ...
    'dropdown': [{ type: _angular_core.ViewChild, args: ['dropdown',] },],
    'searchPanel': [{ type: _angular_core.ViewChild, args: ['searchPanel',] },],
};
